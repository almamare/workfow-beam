...
export function EnhancedCard({
    ...
    const cardVariants = {
        default: 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md dark:hover:shadow-lg',
    ...
    return (
        <Card className={cn(
            ...
            <CardHeader className={cn(
                'border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900',
                sizeClasses[size]
            )}>
