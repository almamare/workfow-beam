            ...
            {items.map((item, idx) => {
                ...
                return (
                    <React.Fragment key={item.href}>
                        ...
                        {isLast ? (
                            <span className="font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-1.5 truncate px-2 py-1 rounded-md bg-gradient-to-r from-brand-sky-50 to-brand-sky-100/50 dark:from-brand-sky-900/20 dark:to-brand-sky-800/10 border border-brand-sky-200/50 dark:border-brand-sky-800/30">
                                {item.icon ?? null}
                                <span className="text-brand-sky-700 dark:text-brand-sky-300">{item.label}</span>
                            </span>
                        ) : (
                            <Link
                                href={item.href}
                                className={cn(
                                    ...
                                    "hover:text-brand-sky-600 dark:hover:text-brand-sky-400",
