                    ...
                    >
                        <div className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            {contractorOptions.length === 0 ? (
                                                ...
                                                contractorOptions.map(contractor => (
                                                    <SelectItem
                                                        key={contractor.id}
                                                        value={contractor.id}
                                                        className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400"
                                                    >
                                                        {contractor.label}
                                                    </SelectItem>
                                                ))
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="project_type" className="text-slate-700 dark:text-slate-200">Project Type *</Label>
                                    <Select
                                        value={projectType}
                                    ...
                                    >
                                        ...
                                        <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
                                            {projectTypes.map(type => (
                                                <SelectItem key={type} value={type} className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400">
                                                    {type}
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
                                            {statuses.map(status => (
                                                <SelectItem key={status} value={status} className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400">
                                                    {status}
                                                </SelectItem>
                                            ))}
                                        </SelectContent>
