...
/* =========================================================================
   ...
   - Uses `useSearchParams` to read taskId from URL: /contracts/update?taskId=123
    ...
    const taskId = searchParams.get('id');
       ...
       if (initialLoading) {
        return (
            ...
            <Loader2 className="h-6 w-6 animate-spin mr-2 text-brand-sky-500" />
                               ...
                               <div className="space-y-4">
                                   <div className="grid gap-4 md:grid-cols-2">
                                               ...
                                               <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
                                                   {contractorOptions.length === 0 ? (
                                                       ...
                                                       contractorOptions.map((c) => (
                                                           <SelectItem key={c.id} value={c.id} className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400">{c.label}</SelectItem>
                                                       ))
                                                   )}
                                               </SelectContent>
                                           </Select>
                                               ...
                                               <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
                                                   {projectOptions.length === 0 ? (
                                                       ...
                                                       projectOptions.map((p) => (
                                                           <SelectItem key={p.id} value={p.id} className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400">{p.label}</SelectItem>
                                                       ))
                                                   )}
                                               </SelectContent>
                                           </Select>
                                       ...
                                       <div className="space-y-2">
                                           ...
                                           <Input id="title" value={form.title} onChange={(e) => updateField('title', e.target.value)} placeholder="Task order title" className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:border-brand-sky-300 dark:focus:border-brand-sky-500 focus:ring-2 focus:ring-brand-sky-100 dark:focus:ring-brand-sky-900/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500" />
                                       ...
                                       <div className="space-y-2">
                                           ...
                                           <Select value={form.status} onValueChange={(value) => updateField('status', value)}>
                                               ...
                                               <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
                                                   {statuses.map((s) => (
                                                       <SelectItem key={s} value={s} className="text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-brand-sky-600 dark:hover:text-brand-sky-400">{s}</SelectItem>
                                                   ))}
                                               </SelectContent>
                                           </Select>
                                       ...
                                       <div className="space-y-2">
                                           ...
                                           <Input id="est_cost" type="number" min="0" step="0.01" value={form.est_cost} onChange={(e) => updateField('est_cost', e.target.value)} placeholder="0" className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:border-brand-sky-300 dark:focus:border-brand-sky-500 focus:ring-2 focus:ring-brand-sky-100 dark:focus:ring-brand-sky-900/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500" />
                               ...
                               <div className="space-y-4">
                                   {form.contract_terms.map((term, index) => (
                                       <div key={index} className="rounded-lg border border-slate-200 dark:border-slate-700 p-3 space-y-2">
                                           ...
                                           <Input placeholder="Term title" value={term.title} onChange={(e) => updateTermField(index, 'title', e.target.value)} className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:border-brand-sky-300 dark:focus:border-brand-sky-500 focus:ring-2 focus:ring-brand-sky-100 dark:focus:ring-brand-sky-900/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500" />
                               ...
                               <div className="grid gap-4 md:grid-cols-3">
                                   {form.documents.map((doc, index) => (
                                       <div key={index} className="rounded-lg border border-slate-200 dark:border-slate-700 p-3 space-y-2">
                                           ...
                                           <Input placeholder="Document title" value={doc.title} onChange={(e) => updateDocTitle(index, e.target.value)} className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:border-brand-sky-300 dark:focus:border-brand-sky-500 focus:ring-2 focus:ring-brand-sky-100 dark:focus:ring-brand-sky-900/50 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500" />
