...
function UpdateInner() {
    ...
    useEffect(() => {
        if (contract) {
            if (contract.approval_status === 'Approved') {
                ...
                router.push(`/contracts/contracts/details?id=${contract.id}`);
                return;
            }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Saved');
            router.push(`/contracts/contracts/details?id=${contractId}`);
        } catch (err: unknown) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-end">
                ...
                <Button type="button" variant="outline" onClick={() => router.push('/contracts/contracts')}>
                    Back
                </Button>
            </div>
