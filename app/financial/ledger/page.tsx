...
const SOURCE_COLOR: Record<string, string> = {
    Bank:       'bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 border-sky-200 dark:border-sky-800',
...
export default function FinancialLedgerPage() {
    ...
    const items      = useSelector(selectFinancialLedgerItems) as LedgerEntry[];
    ...
    const columns: Column<LedgerEntry>[] = [
        {
            key: 'disbursement_id' as keyof LedgerEntry,
            header: 'Ref',
            render: (v: any) => (
        ...
        {
            key: 'transaction_date' as keyof LedgerEntry,
            header: 'Date',
            render: (v: any) => (
        ...
        {
            key: 'project_id' as keyof LedgerEntry,
            header: 'Project',
            render: (v: any) => {
        ...
        {
            key: 'payment_source' as keyof LedgerEntry,
            header: 'Source',
            render: (v: any) => (
        ...
        {
            key: 'currency' as keyof LedgerEntry,
            header: 'Currency',
            render: (v: any) => (
        ...
        {
            key: 'debit_amount' as keyof LedgerEntry,
            header: 'Debit (Out)',
            render: (v: any, row: LedgerEntry) => (
        ...
        {
            key: 'credit_amount' as keyof LedgerEntry,
            header: 'Credit (In)',
            render: (v: any, row: LedgerEntry) => (
        ...
        {
            key: 'balance_after' as keyof LedgerEntry,
        ...
        {
            key: 'posted_by' as keyof LedgerEntry,
            header: 'Posted By',
            render: (v: any) => (
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-200">Financial Ledger</h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1 text-sm md:text-base">
                        Read-only ledger — entries are auto-posted when disbursements are marked as Paid
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <EnhancedCard title="Total Debit (Out)" description="Current page" variant="default" size="sm"
                ...
                <EnhancedCard title="Total Credit (In)" description="Refunds & reversals" variant="default" size="sm"
            ...
            <EnhancedCard
                ...
                description="Filter ledger entries by project, source, and date range"
                variant="default"
                size="sm"
            >
                <div className="space-y-4">
