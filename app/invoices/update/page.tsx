...
import { fetchInvoice, updateInvoice, selectSelectedInvoice, selectInvoicesLoading, clearSelectedInvoice } from '@/stores/slices/invoices';
import { Breadcrumb } from '@/components/layout/breadcrumb';
import { EnhancedCard } from '@/components/ui/enhanced-card';
import type { UpdateInvoicePayload, InvoiceItem } from '@/stores/types/invoices';
...
const UpdateInvoicePageContent: React.FC = () => {
    ...
    const invoiceLoading = useSelector(selectInvoicesLoading);
    ...
    // Update form when selectedInvoice changes
    useEffect(() => {
        if (selectedInvoice) {
            setForm({
    ...
    // Update field value
    const updateField = useCallback((name: keyof Omit<UpdateInvoicePayload, 'id'>, value: any) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await dispatch(updateInvoice(payload)).unwrap();
    ...
    if (!selectedInvoice) {
        return (
            <div className="space-y-4">
                <Breadcrumb />
                <div className="flex items-center justify-center py-20">
                    <p className="text-slate-600 dark:text-slate-400">Invoice not found</p>
                </div>
            </div>
        );
    }
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-end gap-4 justify-between">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mt-2">
                        Modify the details below to update the invoice.
                    </p>
                </div>
                <Button
                    type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <EnhancedCard
                    ...
                    description="Update invoice basic details."
                    variant="default"
                    size="sm"
                >
                    <div className="space-y-4">
