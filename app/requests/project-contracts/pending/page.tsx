...
import { RefreshCw, Clock, Search, X, FileText } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-200">
                        Project Contract Requests â€” Pending Approval
                    </h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">
                        Project contract requests currently assigned to you for review and approval
                    </p>
                </div>
            </div>

            <EnhancedCard title="Search & Filters" description="Search and filter pending project contract requests" variant="default" size="sm">
                <div className="space-y-4">
            ...
            >
                {error ? (
                    ...
                    <EnhancedDataTable
                        ...
                        noDataMessage="No project contract requests pending your approval"
...
export default function ProjectContractRequestsPendingPage() {
    return (
        <Suspense fallback={
            <div className="flex min-h-[40vh] items-center justify-center text-slate-500">Loadingâ€¦</div>
        }>
