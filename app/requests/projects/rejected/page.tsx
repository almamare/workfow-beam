...
function ProjectsRejectedPageContent() {
    ...
    // Filter task requests to only show "Projects" type with "Rejected" status
    const projectRequests = useMemo(() => {
        return taskRequests.filter(req => req.request_type === 'Projects' && req.status === 'Rejected');
    }, [taskRequests]);
    ...
    // Fetch task requests with request_type = "Projects" and status = "Rejected"
    useEffect(() => {
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `rejected_project_requests_${new Date().toISOString().slice(0, 10)}.csv`;
            a.click();
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-200">Rejected Project Requests</h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">
                        Browse and manage all rejected project requests
                    </p>
                </div>
            </div>
            ...
            <EnhancedCard
                ...
                description="Search and filter rejected project requests"
                variant="default"
                size="sm"
            >
                <div className="space-y-4">
            ...
            {/* Requests Table */}
            <EnhancedCard
                title="Rejected Project Requests List"
