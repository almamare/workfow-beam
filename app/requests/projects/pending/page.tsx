...
function ProjectsPendingPageContent() {
    ...
    const statusFilter = 'Pending'; // Fixed status filter
    ...
    // Filter task requests to only show "Projects" type with "Pending" status
    const projectRequests = useMemo(() => {
        return taskRequests.filter(req => req.request_type === 'Projects' && req.status === 'Pending');
    }, [taskRequests]);
    ...
    // Fetch task requests with request_type = "Projects" and status = "Pending"
    useEffect(() => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-slate-200">Pending Project Requests</h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">
                        Browse and manage all pending project requests
                    </p>
                </div>
            </div>
            ...
            <EnhancedCard
                ...
                description="Search and filter pending project requests"
                variant="default"
                size="sm"
            >
                <div className="space-y-4">
            ...
            {/* Requests Table */}
            <EnhancedCard
                title="Pending Project Requests List"
                description={`${totalItems} pending request${totalItems !== 1 ? 's' : ''} found`}
                variant="default"
                size="sm"
                stats={{
                    total: totalItems,
            ...
            >
                <EnhancedDataTable
                    ...
                    noDataMessage="No pending project requests found matching your criteria"
